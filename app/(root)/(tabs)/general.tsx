...
export default function GeneralPage() {
  const { t } = useTranslation("home"); // Reusing "home" since we need general translations
  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      ...
      >
        <Text className="text-primary/60 font-GHKTachileik text-base mb-6">
          Your general financial insights at a glance.
        </Text>
